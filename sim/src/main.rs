...
use strapdown::sim::{
    ClosedLoopConfig, FaultArgs, FilterType, NavigationResult, ParticleFilterConfig,
...
const LONG_ABOUT: &str =
    "STRAPDOWN: A simulation and analysis tool for strapdown inertial navigation systems.
